...
Pod::Spec.new do |s|
  ...
  s.name         = "CJSDToolKits"
  s.version      = "0.0.2"
  s.summary      = "A short description of CJSDToolKits."
...
12345567890
  ...
  s.homepage     = "https://github.com/appledev201888/CJSDToolKits"
  ...
  s.source       = { :git => "https://github.com/appledev201888/CJSDToolKits.git", :tag => "#{s.version}" }
